...
export default function Navbar() {
  ...
  const linksAbogado = [
    ...
    { href: '/abogado/credencial',  label: 'Credencial' },
  ];

  const linksCliente = [
    { href: '/abogados',          label: 'Buscar Abogado' },
  ...
  const linksPublicos = [
    { href: '/abogados', label: 'Profesionales' },
    { href: '/planes',   label: 'Planes' },
  ];

  // Elegir qué links mostrar
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <div className="text-left">
                      <p className="text-sm font-medium text-navy-900 font-body leading-none">
                        {usuario?.nombre}
                      </p>
