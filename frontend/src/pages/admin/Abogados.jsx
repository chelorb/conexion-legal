        ...
        <div className="flex gap-1 px-6 pt-4 shrink-0">
          {[
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (tab !== t.id) e.currentTarget.style.background = '#F0EFED';
              }}
              onMouseLeave={(e) => {
                if (tab !== t.id) e.currentTarget.style.background = '';
              }}
            >
              {t.label}
            </button>
        ...
        <div className="overflow-y-auto flex-1 p-6">
          {tab === 'revision' && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <div key={label} className="rounded-xl p-3" style={{ background: '#F7F6F4' }}>
                    ...
                    <div className="font-body text-sm" style={{ color: '#1C1B18' }}>
                      {val}
                    </div>
                  </div>
                ))}
              ...
              {abogado.descripcion && (
                <div className="rounded-xl p-4" style={{ background: '#F7F6F4' }}>
                  <p className="font-body text-xs mb-2" style={{ color: '#8A8780' }}>
                    Descripción
                  </p>
                  <p
                    className="font-body text-sm leading-relaxed line-clamp-4"
                    style={{ color: '#3A3832' }}
                  >
                    {abogado.descripcion}
                  </p>
              ...
              <div className="space-y-3">
                {[
                  {
                    campo: 'visible',
                    label: 'Visible en búsqueda',
                    desc: 'Aparece en el catálogo público',
                  },
                  {
                    campo: 'matricula_verificada',
                    label: 'Matrícula verificada',
                    desc: 'Muestra el sello de verificación',
                  },
                  ...
                  >
                    ...
                    >
                      <div
                        className={`absolute top-1 w-4 h-4 bg-white rounded-full shadow transition-transform ${datos[campo] ? 'translate-x-6' : 'translate-x-1'}`}
                      />
                    </div>
                  </div>
                ))}
                ...
                <div className="space-y-3 pt-2">
                  ...
                  {accion === 'rechazar' && (
                    <div className="animate-slide-down">
                      ...
                      <textarea
                        rows={3}
                        placeholder="Se enviará al abogado por email..."
                        value={motivo}
            ...
            <form onSubmit={handleSubmit(onSubmitPerfil)} className="space-y-5">
              <div>
                ...
                <div className="rounded-xl p-4 mb-4" style={{ background: '#F7F6F4', border: '1px solid #E8E6E3' }}>
                  ...
                  <p className="font-body text-xs mt-3" style={{ color: '#B86030' }}>
                    ⚠️ Si cambiás el email, el abogado recibirá un aviso automático.
                  </p>
                </div>
    ...
    <div className="min-h-screen" style={{ background: '#F0EFED' }}>
      <div className="page-container py-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="section-subtitle">
              Revisá, aprobá y editá los perfiles de los profesionales.
            </p>
          </div>
        ...
        {conteos.pendiente > 0 && (
          ...
          >
            ...
            <p className="font-body text-sm" style={{ color: '#92400e' }}>
              Hay <strong>{conteos.pendiente}</strong> abogado{conteos.pendiente > 1 ? 's' : ''}{' '}
              esperando revisión.
            </p>
          </div>
        )}
        ...
        <div className="card overflow-hidden">
            ...
            <div>
              {[1, 2, 3].map((i) => (
                <div
                  ...
                  style={{ borderBottom: '1px solid #F7F6F4' }}
                >
                  <div
          ...
          {!cargando && abogadosFiltrados.length === 0 && (
            <div className="py-16 text-center">
              ...
              <p className="font-body text-sm" style={{ color: '#8A8780' }}>
                {tabActivo === 'pendiente'
                  ? 'No hay abogados pendientes de revisión.'
                  : 'Probá otro filtro.'}
              </p>
            </div>
          )}
          ...
          {!cargando &&
            abogadosFiltrados.map((a, idx) => (
              <div
                key={a.id}
                className="flex items-start gap-4 px-6 py-5 transition-colors"
                style={{
                  borderBottom: idx < abogadosFiltrados.length - 1 ? '1px solid #F7F6F4' : 'none',
                }}
                onMouseEnter={(e) => {
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-4 flex-wrap">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <div
                        className="flex items-center gap-1.5 text-xs font-body px-2.5 py-1.5 rounded-full"
